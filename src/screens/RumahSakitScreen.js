...
export default function RumahSakitScreen({ navigation }) {
    const data = [{
        "id": 1,
    ...
    return (
        <View>
            <FlatList data={data} renderItem={({ item }) => (
                <TouchableHighlight onPress={() => navigation.push('Detail_Surat_Masuk')}>
                    <Box paddingTop={3} paddingBottom={3} style={{ backgroundColor: 'white' }} borderBottomWidth="1" borderColor="gray.300" pl={["0", "4"]} pr={["0", "5"]} py="2" paddingLeft={8} paddingRight={18}>
                        <HStack space={[2, 3]} justifyContent="space-between">
                            ...
                            <VStack style={{ width: 260 }}>
                                ...
                                <Badge rounded="full" colorScheme="warning" variant="solid" width={100} marginTop={3}>
                                    Surat Masuk
                                </Badge>
                            </VStack>
                            <Spacer />
